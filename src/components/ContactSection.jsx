          ...
          <motion.div initial={{ opacity: 0, x: 24 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6, delay: 0.15 }} style={{ background: 'var(--bg)', padding: '40px 36px' }}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <div className="form-group">
                ...
                <input className="form-input" placeholder="+91 XXXXX XXXXX" type="tel" {...register('phone')} />
              </div>
              ...
              <div className="form-group">
                ...
                <textarea className="form-input" placeholder="Tell me about your sales challenges..." {...register('message', { required: 'Message is required', minLength: { value: 20, message: 'Please write at least 20 characters' } })} style={{ minHeight: 120 }} />
