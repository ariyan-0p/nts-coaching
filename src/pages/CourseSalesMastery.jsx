...
import { Phone, Mail, MapPin, Send, Linkedin, Instagram, Youtube, Facebook, Globe } from 'lucide-react';
...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="section" ref={ref} style={{ background: 'var(--bg-2)', position: 'relative', overflow: 'hidden', padding: '100px 0' }}>
      {/* Visual Accents */}
      <div style={{ position: 'absolute', top: 0, left: '50%', transform: 'translateX(-50%)', width: 800, height: 1, background: 'linear-gradient(90deg, transparent, var(--red), transparent)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', top: '30%', left: '50%', transform: 'translate(-50%, -50%)', width: 600, height: 600, background: 'radial-gradient(circle, var(--red-dim) 0%, transparent 70%)', pointerEvents: 'none' }} />
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '2px', background: 'var(--border)', border: '1px solid var(--border)' }}>
          {/* Left Panel: Info */}
          ...
          {/* Right Panel: Full Original Form */}
            ...
            <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                ...
                <div className="form-group">
                  ...
                  <input className="form-input" placeholder="your@email.com" type="email" {...register('email', { required: 'Email is required', pattern: { value: /^\S+@\S+$/, message: 'Invalid email' } })} />
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div className="form-group">
                  ...
                  <input className="form-input" placeholder="+91 XXXXX XXXXX" type="tel" {...register('phone', { required: 'Phone is required' })} />
              ...
              <div className="form-group">
                ...
                <textarea className="form-input" placeholder="Describe your sales challenges and what you want to achieve..." {...register('message', { required: 'Message is required', minLength: { value: 10, message: 'Please provide more detail' } })} style={{ minHeight: 110 }} />
